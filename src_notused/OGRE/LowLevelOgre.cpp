...
bool LowLevelOgre::go(void) {
	...
	Ogre::String pluginsDirectory = Ogre::String("/usr/lib/x86_64-linux-gnu/OGRE-1.7.4/");
...
#ifdef _DEBUG
		mRoot->loadPlugin(pluginsDirectory + *j + Ogre::String("_d"));
#else
		mRoot->loadPlugin(pluginsDirectory + *j);
#endif
	}
	...
	Ogre::ResourceGroupManager::getSingleton().addResourceLocation("/usr/share/OGRE-1.7.4/media/materials/programs", "FileSystem", "General");
	Ogre::ResourceGroupManager::getSingleton().addResourceLocation("/usr/share/OGRE-1.7.4/media/materials/scripts", "FileSystem", "General");
	Ogre::ResourceGroupManager::getSingleton().addResourceLocation("/usr/share/OGRE-1.7.4/media/materials/textures", "FileSystem", "General");
	Ogre::ResourceGroupManager::getSingleton().addResourceLocation("/usr/share/OGRE-1.7.4/media/models", "FileSystem", "General");
